#!/usr/bin/env python3
"""Mechanical jargon detector for copy:plain.
...
`.claude/skills/copy/plain/terms.md`. A term recorded as fine for an audience
...
PROJECT_REL = Path(".claude") / "skills" / "copy" / "plain" / "terms.md"
